...
!** define grid template 3
      IF(MAPTYPE == 1) THEN     !LAmbert Conformal
       ...
       ifield3     = 0
!
!tst       ifield3(1)  = 6          !Earth assumed spherical with radius of 6,371,229.0m
       ifield3(1)  = 1          ! Earth assumed spherical with user-defined radius
       ifield3(2)  = 0          ! scaling factor
       ifield3(3)  = 6370000    ! radius in meters
